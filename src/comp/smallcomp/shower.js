    ...
    <>
      <div className={Layout.navHolder}>
        <div className={Layout.ContH}>
          <div className={Layout.maniHolder}>
            ...
            <div>
              <a className={Layout.a} href="https://www.arkitektbedriftene.no/">
                arkitektbedriftene.no
              </a>
            </div>
            <div>
              <a className={Layout.a} href="https://www.maks.no/">
                MAKS
              </a>
            </div>
            <div>
              <a className={Layout.a} href="https://www.byggsok.net/">
                MAKS-søk
              </a>
            </div>
            <div>
      ...
      <div className={Layout.overlay}>
        <div className={Layout.overHolder}>
          ...
          <button onClick={toggleSidebar} className={Layout.sidbarbutton}>
            ☰
          </button>
        </div>
      </div>
